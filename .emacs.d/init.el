...
(defun web-mode-hook ()
  ...
  ;;  (setq web-mode-comment-style 2) ;; コメント
  )
...
(defun php-completion-hook ()
  (when (require 'php-completion nil t)
    ...
    (when (require 'auto-complete nil t)
      ...
      (add-to-list 'ac-sources 'ac-source-php-completion 'ac-source-filename 'ac-source-etags)
...
(add-to-list 'flymake-allowed-file-name-masks '("\\.ctp$" flymake-php-init))
...
;; ガーベッジコレクションの頻度を下げる(デフォルト 400000)
(setq gc-cons-threshold 5242880)

;; file名の補完で大文字・小文字を区別しない
(setq completion-ignore-case t)

;; バッファの自動読み込み
(global-auto-revert-mode 1)

;; globalなC-z(サスペンド)を無効化
